...
TRANSLATIONS = {
    ...
    "options.binding_group.control_groups": "Groupes de contrôle",
    ...
    "options.binding.selection_group_assign": "Assigner au groupe {slot}",
    "options.binding.selection_group_select": "Sélectionner le groupe {slot}",
