...
def UnitFactory(unit: UnitType, enemy: bool, pos):
    match(unit):
        case UnitType.SCOUT:
            ...
            es.add_component(entity, RadiusComponent(bullet_cooldown=2, bullets_front= 1))
        ...
        case UnitType.MARAUDEUR:
            ...
            es.add_component(entity, RadiusComponent(bullet_cooldown=4, can_shoot_from_side=True, bullets_front=2, bullets_sides=2))
            es.add_component(entity, TeamComponent(1 if not enemy else 2))
        ...
        case UnitType.LEVIATHAN:
            ...
            es.add_component(entity, RadiusComponent(bullet_cooldown=8, can_shoot_from_side=True, bullets_front=2, bullets_sides=3))
            es.add_component(entity, TeamComponent(1 if not enemy else 2))
