...
class SpriteManager:
    ...
    def _initialize_sprite_registry(self):
        ...
        sprites = [
            ...
            SpriteData(SpriteID.ALLY_KAMIKAZE, "assets/sprites/units/ally/Kamikaze.png", 80, 100, "Kamikaze allié"),
            ...
            SpriteData(SpriteID.ENEMY_KAMIKAZE, "assets/sprites/units/enemy/Kamikaze.png", 80, 100, "Kamikaze ennemi"),
