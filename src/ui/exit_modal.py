...
class ExitConfirmationModal:
    ...
    def open(self, surface: Optional[pygame.Surface]) -> None:
    ...
    def handle_event(self, event: pygame.event.Event, surface: Optional[pygame.Surface]) -> Optional[str]:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_ESCAPE:
                return self._activate_choice(0)
            return None
    ...
    def render(self, surface: pygame.Surface) -> None:
        ...
        title = self.font_title.render(t("game.exit_modal.title"), True, (255, 255, 255))
        panel.blit(title, ((panel.get_width() - title.get_width()) // 2, 24))

        message = self.font_message.render(t("game.exit_modal.message"), True, (220, 220, 230))
